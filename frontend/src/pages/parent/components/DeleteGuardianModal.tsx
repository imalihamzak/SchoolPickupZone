          ...
          <div className="px-6 py-5">
            <div className="text-center sm:text-left">
              ...
              <p className="text-sm text-gray-500 mb-4">
                You're about to permanently remove <span className="font-semibold text-gray-900">{guardian.full_name}</span> ({guardian.relation}). This action cannot be undone.
              </p>
              <div className="bg-yellow-50 text-yellow-800 rounded-md p-3 mb-4 text-sm">
                <strong>Warning:</strong> All pickup and vehicle data associated with this guardian will be deleted.
              </div>
            </div>
          </div>
