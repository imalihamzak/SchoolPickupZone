// components/DeleteDocumentModal.tsx
        ...
        <div className="relative transform overflow-hidden rounded-lg bg-white shadow-xl transition-all max-w-md w-full">
          ...
          <div className="px-6 py-5">
            <div className="text-center sm:text-left">
              <h3 className="text-lg font-medium text-gray-900 mb-2">Are you sure you want to delete this document?</h3>
              <p className="text-sm text-gray-500 mb-4">
                <span className="font-semibold text-gray-900">{document.type}</span> — {document.fileName}
              </p>
              <div className="bg-yellow-50 text-yellow-800 rounded-md p-3 mb-4 text-sm">
                <strong>Warning:</strong> This document will be permanently deleted.
              </div>
            </div>
          </div>
