          ...
          <div className="px-6 py-5">
            <div className="text-center sm:text-left">
              ...
              <p className="text-sm text-gray-500 mb-4">
                You're about to permanently remove <span className="font-semibold text-gray-900">{user.name}</span> ({user.role}). This action cannot be undone.
              </p>
              <div className="bg-yellow-50 text-yellow-800 rounded-md p-3 mb-4 text-sm">
                <strong>Warning:</strong> This will revoke access and delete all data associated with this user.
              </div>
            </div>
          </div>
